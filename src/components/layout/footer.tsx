...
function VisaIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg 
        ...
        width="64" height="64"
        {...props}>
       <path d="M19.988 6.012h-16c-.552 0-1 .448-1 1v10c0 .552.448 1 1 1h16c.552 0 1-.448 1-1v-10c0-.552-.448-1-1-1zm-16 11.001c-.004-.011 0-.495-.001-.5v-9.501h16.002v9.501c0 .005.003.49-.001.5h-16.001z" fill="#00579e"/>
       <path d="M10.229 15.2h-1.39l-1.65-5.91h1.56l.87 3.97.23 1.05.2-1.04.62-3.98h1.49zm4.21-5.03c.57-.31 1.22-.52 1.93-.52.57 0 1.13.12 1.63.36l.22-.9h1.36l-.37 5.92h-1.5l.2-.99c-.43.32-.97.5-1.57.5-1.35 0-2.33-.82-2.33-2.02.01-1.05.79-1.69 1.75-2.35zm1.86 3.01c.72 0 1.25-.43 1.25-1.05 0-.52-.4-.88-1.05-.88-.47 0-.91.22-.91.22l-.45 1.55c.29.12.56.16.76.16zm-7.66-.45l.93-4.52h-2.81l-1.66 5.91h1.54l.32-1.39h2.38l-.7 1.39zm-1.01-2.28h-1.23l.53-2.25h1.22z" fill="#00579e"/>
    </svg>
  )
}
