...
function VisaIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            {...props}
        >
            <path d="M11.5,14.5H11.5L10,9.9h1.3l0.7,3.1c0.2,0.9,0.3,1.5,0.4,1.8h0.1c0.1-0.3,0.2-0.9,0.4-1.8l0.7-3.1H14L12.5,14.5z M20.9,11.9c0-1.2-0.6-1.8-1.7-1.8c-0.7,0-1.2,0.3-1.6,0.5L17.2,9c0.6-0.3,1.4-0.5,2.4-0.5c2.3,0,3.5,1.1,3.5,2.9 c0,1.3-0.6,2.1-1.5,2.6c0.9,0.3,1.2,1,1.2,1.9c0,1.4-1.2,2.5-3,2.5c-1.5,0-2.5-0.6-3-0.9l0.4-1.5c0.5,0.3,1.3,0.6,2.1,0.6 c1,0,1.5-0.4,1.5-1.1C21.1,12.7,20.9,12.4,20.9,11.9z M16.7,8.6L15.4,15l-1.3,0l1.3-6.4H16.7z M8.9,8.6l-2,6.4H5.4l1.1-3.6 c-0.5-0.2-1-0.4-1.3-0.5L4.8,9.1C5.2,9.3,6,9.6,6.6,9.8l0.4-2.7L4.5,6.5L4.8,5h4.6l-0.4,1.5L6.6,7.1l0.6,2.8L8.9,8.6z" fill="#1434cb"></path>
        </svg>
    )
}
